...
def generate_change_analysis_prompt(change_data: Dict[str, Any], domain_context: Dict[str, Any], confounding_factors: List[Dict[str, Any]]) -> Dict[str, Any]:
...
def generate_trend_analysis_prompt(metric_name: str, trend_data: List[Dict[str, Any]], domain_context: Dict[str, Any]) -> Dict[str, Any]:
...
def generate_category_analysis_prompt(category: str, metrics_stats: Dict[str, Any], sample_changes: List[Dict[str, Any]], domain_context: Dict[str, Any]) -> Dict[str, Any]:
