...
class ChangeAnalyzer:
    ...
    def analyze_change_impact(self, change_id: str) -> Dict:
        ...
        similar_category_changes = self.index_builder.search_by_category(change.category)
        ...
        if self.llm_service and self.llm_service.is_enabled:
            ...
            # Get domain context
            domain_context = {
                "category_context": self.domain_manager.get_relevant_category_context(change.category),
                "relevant_concepts": self.domain_manager.get_relevant_concepts(change.description),
